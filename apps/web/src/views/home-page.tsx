...
export default function HomePage() {
  return (
    ...
    >
      <div
        className="pointer-events-none fixed inset-0 z-50 hidden opacity-[0.03] mix-blend-overlay md:block"
        style={{
          backgroundImage:
      ...
      <div className="relative z-10" data-hero-section>
        <CinematicHero />
      </div>
      ...
      <PartnerProgramsTickerBanner triggerSelector="[data-hero-section]" />
    </div>
  );
}
